...
public class TranslateMusicFragment extends BaseFragment {
    private static TranslateMusicFragment sTranslateMusicFragment;

    public static TranslateMusicFragment getInstance() {
        if (sTranslateMusicFragment == null) {
            sTranslateMusicFragment = new TranslateMusicFragment();
        }
        return sTranslateMusicFragment;
    }
